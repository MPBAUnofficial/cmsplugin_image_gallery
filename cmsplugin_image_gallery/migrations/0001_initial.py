...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cmsplugin_image_gallery', ['GalleryPlugin'])

        # Adding model 'Image'
        db.create_table('cmsplugin_image_gallery_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_image_gallery.GalleryPlugin'])),
            ...
            ('link_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal('cmsplugin_image_gallery', ['Image'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cmsplugin_image_gallery_image')
    ...
    models = {
        ...
        'cmsplugin_image_gallery.galleryplugin': {
        ...
        'cmsplugin_image_gallery.image': {
            'Meta': {'ordering': "('inline_ordering_position',)", 'object_name': 'Image'},
            'alt': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cmsplugin_image_gallery.GalleryPlugin']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'link_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
    ...
    complete_apps = ['cmsplugin_image_gallery']