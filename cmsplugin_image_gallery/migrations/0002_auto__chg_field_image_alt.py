...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cmsplugin_image_gallery_image', 'alt', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'Image.alt'
        db.alter_column('cmsplugin_image_gallery_image', 'alt', self.gf('django.db.models.fields.TextField')())
